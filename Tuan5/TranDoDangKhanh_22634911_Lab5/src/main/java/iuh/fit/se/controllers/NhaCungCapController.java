...
@WebServlet(name = "nhacungcapController", urlPatterns = "/nhacungcaps")
public class NhaCungCapController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.setAttribute("nhacungcaps", nhaCungCapDAO.findAll());
...
//        List<NhaCungCap> nhacungcaps = List.of(
//                new NhaCungCap("NCC01", "Samsung Việt Nam", "Hà Nội", "0123456789"),
//                new NhaCungCap("NCC02", "Apple Inc", "Hồ Chí Minh", "0987654321"),
//                new NhaCungCap("NCC03", "Xiaomi Corp", "Đà Nẵng", "0911222333"),
//
//        );
//
//        nhacungcaps.forEach(nhaCungCapDAO::);
//    }
